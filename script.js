...
function gpa()
{
    ...
    if (fname == "")
    {
    alert("Your first input is blank :(");
    }
    else if(fname_1 == "")
    {
    alert("Your second input is blank :(");
    }
    else if(fname_2 == "")
    {
    alert("Your third input is blank :(");
    }
    else if(fname_3 == "")
    {
    alert("Your fourth input is blank :(");
    }
    else if(fname_4 == "")
    {
    alert("Your fifth input is blank :(");
    }
    else if(fname_5 == "")
    {
    alert("Your sixth input is blank :(");
    }
    else if(fname_6 == "")
    {
    alert("Your seventh input is blank :(");
    }
